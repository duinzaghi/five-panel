...
export class PanelService {
  getPanels(): Panel[] {
    const panels: Panel[] = [
      { id: 1, name: 'Tree Control', type: 'tree-control'},
      { id: 2, name: 'Filter Builder', type: 'filter-builder'},
      { id: 3, name: 'Diagram', type: 'diagram'},
      { id: 4, name: 'Gantt', type: 'gantt'},
      { id: 5, name: 'Tree List', type: 'tree-list'},
    ];
    return panels;
  }
