...
export class GoldenLayoutHostComponent implements OnDestroy {
  ...
  constructor(private _appRef: ApplicationRef,
    ...
    this.goldenLayoutComponentService.registerComponentType(TreeViewComponent.componentTypeName, TreeViewComponent);
    this.goldenLayoutComponentService.registerComponentType(FilterBuilderComponent.componentTypeName, FilterBuilderComponent);
    this.goldenLayoutComponentService.registerComponentType(DiagramComponent.componentTypeName, DiagramComponent);
    this.goldenLayoutComponentService.registerComponentType(GanttComponent.componentTypeName, GanttComponent);
    this.goldenLayoutComponentService.registerComponentType(TreeListComponent.componentTypeName, TreeListComponent);
